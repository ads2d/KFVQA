...
def main(config):
    ...
    if config.database == 'LSVQ_test':
        ...
        videos_dir = os.path.join(config.data_path, 'videos/KoNViD_1k_image')
        feature_dir = os.path.join(config.data_path, 'KoNViD-1-feature')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_database', type=str, default='KoNViD-1k')
    parser.add_argument('--model_name', type=str, default='UGC_BVQA_model')

    parser.add_argument('--num_workers', type=int, default=5)

    # misc
    parser.add_argument('--trained_model', type=str, default='ckpts/UGC_BVQA_model_KoNViD-1k_L1RankLoss_NR_v0_epoch_1_SRCC_0.775162.pth')
